...
if ($con->connect_error) {
	...
	$con->query("CREATE TABLE `" . DB_NAME . "`.`application` ( `name` VARCHAR(20) NOT NULL , `sex` CHAR NOT NULL , `tel` VARCHAR(15) NOT NULL , `grade` INT NOT NULL , `college` INT NOT NULL , `dorm` VARCHAR(10) NULL , `department` INT NOT NULL , `alternative` INT NULL , `adjustment` BOOL NOT NULL , `introduction` VARCHAR(255) NULL , `timestamp` TIMESTAMP NOT NULL , `information` VARCHAR(255) NULL , `note` VARCHAR(255) NULL ) ENGINE = InnoDB CHARSET=utf8;");
