...
if ($con->connect_error) {
	...
	$con->query("CREATE TABLE `" . DB_NAME . "`.`application` ( `name` TEXT NOT NULL , `sex` CHAR NOT NULL , `tel` TEXT NOT NULL , `grade` INT NOT NULL , `college` INT NOT NULL , `dorm` TEXT NULL , `department` INT NOT NULL , `alternative` INT NULL , `adjustment` TEXT NOT NULL , `introduction` TEXT NULL , `timestamp` TIMESTAMP NOT NULL , `information` TEXT NULL , `note` TEXT NULL ) ENGINE = InnoDB;");
